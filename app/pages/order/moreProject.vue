<template>
  <div class="min-h-screen py-6 sm:py-8 lg:py-10 bg-[#FAF9F6]" dir="rtl">
    ...
    <section class="max-w-6xl mx-auto px-4 text-center mt-[50px]">
      ...
      <!-- تب‌های دسته‌بندی -->
<!-- کانتینر جدید با استایل مشابه بخش پایین -->
<div class="flex justify-center mb-8 lg:mb-10 px-2">
  <div class="w-full max-w-[846px] lg:w-[846px] h-auto lg:h-[59px] bg-white rounded-[30px] lg:rounded-[48px] p-1 shadow-sm border border-gray-100 flex flex-nowrap items-center justify-center gap-1 sm:gap-2 overflow-hidden">
    ...
    <!-- دکمه‌ها با همان استایل قبلی شما -->
    <button 
    ...
    <section class="max-w-6xl mx-auto px-4 pb-12 sm:pb-16 lg:pb-20">
      ...
      <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 min-h-0 lg:min-h-[700px]">
        <NuxtLink 
      ...
      <!-- کنترل‌های اسلایدر -->
<!-- کنترل‌های اسلایدر (همیشه نمایش داده می‌شود) -->
<div class="flex items-center justify-between mt-8 sm:mt-10 lg:mt-12 px-4 max-w-6xl mx-auto">
  
  <!-- دکمه‌ها: سمت چپ (flex-row) -->
...
const projects = [
  { id: 1, title: 'نام پروژه 1', category: 'طراحی سایت', image: '/images/preview3.jpg' },
  { id: 2, title: 'نام پروژه 2', category: 'طراحی سایت', image: '/images/preview2.jpg' },
  { id: 3, title: 'نام پروژه 3', category: 'طراحی سایت', image: '/images/preview.jpg' },
  { id: 4, title: 'نام پروژه 4', category: 'طراحی سایت', image: '/images/content1.jpg' },
  { id: 5, title: 'نام پروژه 5', category: 'طراحی سایت', image: '/images/preview.jpg' },
  { id: 6, title: 'نام پروژه 6', category: 'طراحی سایت', image: '/images/preview3.jpg' },
  { id: 7, title: 'نام پروژه 7', category: 'طراحی سایت', image: '/images/preview2.jpg' },
  { id: 8, title: 'نام پروژه 8', category: 'برگزاری ایونت', image: '/images/content1.jpg' },
  { id: 9, title: 'نام پروژه 9', category: 'برگزاری ایونت', image: '/images/preview.jpg' },
  { id: 10, title: 'نام پروژه 10', category: 'برگزاری ایونت', image: '/images/preview3.jpg' },
  { id: 11, title: 'نام پروژه 11', category: 'تولید محتوا', image: '/images/preview2.jpg' },
  { id: 12, title: 'نام پروژه 12', category: 'تولید محتوا', image: '/images/content1.jpg' },
  { id: 13, title: 'نام پروژه 13', category: 'تولید محتوا', image: '/images/content1.jpg' },
  { id: 14, title: 'نام پروژه 14', category: 'تولید محتوا', image: '/images/preview3.jpg' },
  { id: 15, title: 'نام پروژه 15', category: 'تولید محتوا', image: '/images/preview2.jpg' },
  { id: 16, title: 'نام پروژه 16', category: 'تولید محتوا', image: '/images/preview2.jpg' },
  { id: 17, title: 'نام پروژه 17', category: 'تولید محتوا', image: '/images/content1.jpg' },


];

const filteredProjects = computed(() => {
  if (activeCategory.value === 'مشاهده همه') return projects;
  return projects.filter(p => p.category === activeCategory.value);
});

const totalSlides = computed(() => Math.ceil(filteredProjects.value.length / itemsPerPage));
