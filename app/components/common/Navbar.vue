<template>
  <nav v-if="!isLotteryPage" class="sticky top-6 z-[999] w-[95%] sm:w-[92%] min-[1100px]:w-[92%] xl:w-[1110px] min-[1920px]:w-[1600px] h-auto min-[1100px]:h-[70px] min-[1920px]:h-[88px] mx-auto bg-white dark:bg-[#CECDCD] rounded-[1.75rem] sm:rounded-[2rem] min-[1100px]:rounded-full px-4 sm:px-6 min-[1920px]:px-10 py-2.5 sm:py-3 flex flex-col min-[1100px]:flex-row items-center justify-between shadow-[0_4px_12px_rgba(0,0,0,0.05)] dark:shadow-[0_4px_12px_rgba(0,0,0,0.3)] border border-gray-100 dark:border-dark-border/30 transition-all duration-300" dir="ltr">
    ...
    <div class="relative flex w-full min-[1100px]:w-auto min-[1100px]:order-last justify-between items-center px-1 min-[1100px]:px-0">
      ...
      <div class="min-[1100px]:hidden flex items-center gap-3 sm:gap-4 text-[#0F184B] dark:text-dark-text-deep font-roboto font-normal text-[12px] sm:text-[13px] whitespace-nowrap">
        <NuxtLink to="/" exact-active-class="!font-bold" class="hover:text-teal-700 dark:hover:text-dark-accent transition" @click="isOpen = false">خانه</NuxtLink>
        <NuxtLink to="/order" exact-active-class="!font-bold" class="hover:text-teal-700 dark:hover:text-dark-accent transition" @click="isOpen = false">سفارش‌ پروژه</NuxtLink>
        <NuxtLink to="/articles" exact-active-class="!font-bold" class="hover:text-teal-700 dark:hover:text-dark-accent transition" @click="isOpen = false">مقالات</NuxtLink>
        <NuxtLink to="/about" exact-active-class="!font-bold" class="hover:text-teal-700 dark:hover:text-dark-accent transition" @click="isOpen = false">درباره ما</NuxtLink>
      </div>
    ...
    <div
      class="w-full flex flex-col overflow-hidden transition-all ease-[cubic-bezier(0.4,0,0.2,1)] duration-500
             min-[1100px]:flex min-[1100px]:flex-row min-[1100px]:items-center min-[1100px]:overflow-visible min-[1100px]:max-h-none min-[1100px]:opacity-100 min-[1100px]:translate-y-0 min-[1100px]:mt-0 min-[1100px]:gap-6"
      :class="isOpen
    ...
    >
      ...
      <div class="hidden min-[1100px]:flex items-center gap-2 pl-4 border-l border-gray-200 dark:border-dark-border/40 shrink-0">
        <button
          @click="toggleLang"
      ...
      <div class="flex flex-col min-[1100px]:flex-row min-[1100px]:flex-row-reverse items-center justify-center gap-3 sm:gap-5 min-[1100px]:gap-8 min-[1920px]:gap-10 text-[#0F184B] dark:text-dark-text-deep font-roboto font-normal text-[14px] sm:text-[15px] min-[1100px]:text-[16px] min-[1920px]:text-[24px] w-full min-[1100px]:flex-1 min-[1100px]:whitespace-nowrap">
        <NuxtLink to="/" exact-active-class="!text-[#0F184B] dark:!text-dark-text-deep !font-bold" class="hidden min-[1100px]:block hover:text-teal-700 dark:hover:text-dark-accent transition" @click="isOpen = false">خانه</NuxtLink>
        <NuxtLink to="/order" exact-active-class="!text-[#0F184B] dark:!text-dark-text-deep !font-bold" class="hidden min-[1100px]:block hover:text-teal-700 dark:hover:text-dark-accent transition" @click="isOpen = false">سفارش‌ پروژه</NuxtLink>
        ...
        <NuxtLink to="/articles" exact-active-class="!text-[#0F184B] dark:!text-dark-text-deep !font-bold" class="hidden min-[1100px]:block hover:text-teal-700 dark:hover:text-dark-accent transition" @click="isOpen = false">مقالات</NuxtLink>
        <NuxtLink to="/about" exact-active-class="!text-[#0F184B] dark:!text-dark-text-deep !font-bold" class="hidden min-[1100px]:block hover:text-teal-700 dark:hover:text-dark-accent transition" @click="isOpen = false">درباره ما</NuxtLink>
        ...
        <NuxtLink to="/order/moreProject" exact-active-class="!text-[#0F184B] dark:!text-dark-text-deep !font-bold" class="min-[1100px]:hidden hover:text-teal-700 dark:hover:text-dark-accent transition" @click="isOpen = false">نمونه پروژه ها</NuxtLink>
