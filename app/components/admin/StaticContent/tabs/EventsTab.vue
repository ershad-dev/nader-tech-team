  ...
  <div>
    ...
    >
      <div class="flex items-center justify-between mb-3">
        <span class="font-bold text-[#000000] dark:text-white text-[14px]">آیتم جدید در «ایونت‌ها»</span>
    ...
    <div v-else-if="!items.length" class="flex flex-col items-center justify-center h-40 text-center gap-2">
      <p class="text-[#454C6A]/70 dark:text-white/70 text-[13px]">هنوز آیتمی برای صفحه «ایونت‌ها» ثبت نشده است.</p>
    </div>
