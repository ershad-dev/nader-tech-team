...
const visibleProjects = computed(() => {
  return projects.value.slice(currentIndex.value, currentIndex.value + 3);
});
...
<template>
  <div class="min-h-screen bg-[url('/images/order-bg.png')] bg-cover bg-center py-10 -mt-[70px]">
    
    <div class="max-w-6xl mx-auto">
      <h1 class="bg-[#fcfaf4] w-[200px] text-[#2d6a66] font-[18px] py-3 px-12 rounded-[19px] border-2 border-[#2d6a66]/20 shadow-sm hover:shadow-md transition-al mt-[100px]">طراحی سایت</h1>
