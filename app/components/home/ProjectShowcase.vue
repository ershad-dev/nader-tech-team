...
<div class="flex justify-center mb-8 lg:mb-10 px-2">
  <div class="w-full max-w-[846px] lg:w-[846px] min-[1920px]:w-[1000px] h-auto lg:h-[59px] min-[1920px]:h-[72px] bg-white rounded-[30px] lg:rounded-[48px] p-1 shadow-sm border border-gray-100 flex flex-nowrap items-center justify-center gap-1 sm:gap-2 overflow-hidden">
...
<div class="max-w-6xl min-[1920px]:max-w-[1600px] mx-auto px-4 py-4 lg:py-8 -mt-[20px]" dir="rtl">
  <div class="flex flex-row items-center justify-between gap-2">
    ...
    <h2 class="text-[15px] sm:text-[20px] lg:text-[28px] min-[1920px]:text-[32px] font-roboto text-[#0F184B] font-normal">
      پیش نمایش از پروژه ها
    </h2>

<NuxtLink
  to="/order/moreProject"
  class="bg-[#2C7379] px-4 sm:w-[147px] min-[1920px]:w-[170px] h-[30px] sm:h-[45px] min-[1920px]:h-[52px] text-white rounded-[14px] sm:rounded-[19px] text-[11px] sm:text-[17px] min-[1920px]:text-[19px] font-medium transition-all hover:bg-[#2C7379] flex items-center justify-center gap-2 shadow-md font-roboto whitespace-nowrap overflow-hidden"
>
...
<section class="max-w-6xl min-[1920px]:max-w-[1600px] mx-auto px-4 mb-12 xl:mb-20">
  <div class="relative rounded-[2rem] xl:rounded-[3rem] overflow-hidden p-6 xl:p-12 min-[1920px]:p-16 bg-[#67A9A8] xl:bg-white/20">
    ...
    <div class="relative z-10 flex flex-col xl:flex-row items-center gap-6 xl:gap-12 min-[1920px]:gap-16 min-[1920px]:flex-nowrap">
      <div class="flex-1 w-full">
        <img 
            ...
            class="w-full h-[220px] xl:w-[506px] xl:h-[386px] min-[1920px]:w-[650px] min-[1920px]:h-[480px] object-cover rounded-tl-[17px] rounded-br-[17px] rounded-tr-[65px] rounded-bl-[65px] shadow-xl transition-all duration-500" 
          />
      </div>
